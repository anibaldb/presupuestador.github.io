...
function nnn(){
    ...
    if (repuestoPesos<20500){

        var presuCliente = (repuestoPesos*0.85 + quieroGanar)

    }else if(repuestoPesos>=20500 && repuestoPesos<=34500){

        presuCliente = (repuestoPesos*0.85 *2)

    }else{

        presuCliente = (repuestoPesos*0.85 *1.7)
